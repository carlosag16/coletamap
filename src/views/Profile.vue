      ...
      <div class="section profile-content">
        <div class="container">
          ...
          <div class="description text-center">
            <p>
              Sou estudante de engenharia da computação e busco me profissionalizar cada dia mais com as novas tecnologias do mercado. Atualmente desenvolvedor front-end e líder na empresa 'tal' para desenvolvimento de site.
            </p>
          </div>
...
export default {
  ...
  props: {
    ...
    img: {
      type: String,
      default: require("@/assets/img/faces/carlos.jpg")
    }
  },
  computed: {
    headerStyle() {
